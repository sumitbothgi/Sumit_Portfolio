...
const PROFILE = {
  ...
  resumeUrl: "/SUMIT BOTHGI RESUME.pdf", // e.g., "/Sumit_Bothgi_Resume.pdf"
};
...
const ABOUT = {
  ...
  highlights: [
    ...
    "Java • Spring Boot • Hibernate • JSP • Servlet • JDBC • SQL  • PostgreSQL",
    "Frontend: React, HTML, CSS, JavaScript, Tailwind, Now i'm Learning MERN Stack",
    "Tools: Git, Maven, Eclipse, VS Code, Eclipse",
  ],
  timeline: [
    {
      ...
      org: "SPPU, Pune",
      period: "2021 – 2024",
      details: "Foundations in CS, OOP, Data Structures using C, Computer Networks, Python, Java, PHP,DBMS, and web development.",
    },
    {
...
const PROJECTS = [
  {
    ...
    github: "https://github.com/sumitbothgi/Jwellery_Store_Project/tree/main/JwellerySystem/src/main",
    demo: "https://github.com/sumitbothgi/Jwellery_Store_Project/blob/main/JwellerySystem/src/main/MainPage.java",
  },
  {
    ...
    demo: "https://github.com/sumitbothgi/Online-Examination-System/blob/main/src/main/webapp/index.html",
  },
  {
...
export default function Portfolio() {
  ...
  {PROFILE.resumeUrl ? (
    ...
    <p className="px-6 text-center text-sm text-zinc-600 dark:text-zinc-300">
      Add your resume PDF link to <code>PROFILE.resumeUrl</code> above to enable downloads.
    </p>
  )}
</Card>
      ...
      <footer className="border-t py-10 text-center text-sm">
        <Container>
          <p>© {new Date().getFullYear()} {PROFILE.name} • Built with Sumit Bothgi❤️ using React & Tailwind CSS</p>
        </Container>
      </footer>
    </div>
  );
